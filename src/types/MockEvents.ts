...
export const mockEvents: Event[] = [
  ...
  },
  {
    ...
    featured: false,
    attendees: 800,
    description: 'Experience the best electronic music under the stars. World-class DJs and incredible light shows await.',
    organizer: {
