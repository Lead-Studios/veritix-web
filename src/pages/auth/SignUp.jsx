  ...
  return (
    <AuthInnerLayout isLeft>
      ...
      <div className="flex flex-col items-center justify-between w-full">
        <h2 className="text-2xl md:text-3xl font-bold text-[#000625] mb-8 text-center">Create Your Account</h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full">
          {/* Name row */}
          <div className="w-full flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <label htmlFor="firstName" className="block text-sm font-medium text-[#121212] mb-3">
                First Name
              </label>
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <InputComponent id="firstName" className="" label="First Name" type="text" register={register} />
              </div>
              {errors.firstName && <p className="text-red-500 text-xs mt-1">{errors.firstName.message}</p>}
            </div>

            <div className="flex-1">
              <label htmlFor="lastName" className="block text-sm font-medium text-[#121212] mb-3">
                Last Name
              </label>
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <InputComponent id="lastName" label="Lastname" type="text" register={register} />
              </div>
          ...
          {/* Email */}
          <div>
            <label htmlFor="email" className="block text-sm font-medium text-[#121212] mb-3">
              Email
            </label>
            <div className="mt-1 relative rounded-md shadow-sm">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <InputComponent id="email" className="" label="Email Address" type="email" register={register} />
            </div>
          ...
          {/* Password */}
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-[#121212] mb-3">
              Password
            </label>
            <div className="mt-1 relative rounded-md shadow-sm">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <InputComponent id="password" label="Password" type="password" isPasswordField={true} register={register} />
            </div>
...
[25deg,red_5%,yellow_60%,lime_90%,teal]
        ...
        <div className="mt-8 relative w-full">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-[#E6EAFF] text-[#013237]">or register with</span>
          </div>
        </div>
