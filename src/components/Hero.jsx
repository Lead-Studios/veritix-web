     ...
     />
          ...
          >
            ...
            <motion.h1
              ...
              animate="visible"
              variants={itemVariants}
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white font-bold leading-tight md:leading-[100%] font-[FONTSPRING]"
              style={{ fontFamily: "FONTSPRING" }}
            >
              Discover, Own, and Trade{" "}
              <span className="block sm:inline">
            ...
            <motion.p
              variants={itemVariants}
              className="w-full max-w-lg mx-auto mt-4 rounded-[50px] px-4 py-3 text-[16px] sm:text-[18px] md:text-[20px] leading-[130%] text-white font-[400] font-[Poly] tracking-[0%]"
            >
              Discover real-life events, mint NFT tickets, and earn rewards with crypto.
            </motion.p>
            ...
            >
              ...
              <a
                href="#"
                className="md:w-[140px] md:h-[50px] rounded-[50px] px-6 py-3 border-2 border-[#00FFA0] text-[#00FFA0] flex text-center text-lg font-medium shadow-md hover:bg-[#81e7c2] hover:text-white transition"
              >
                Learn More
              </a>
            </motion.div>
