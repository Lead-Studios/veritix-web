  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center justify-between">
        <p className="text-xs uppercase tracking-widest text-brand-accent">Recent Activity</p>
        <Link href="/events" className="text-xs text-brand-primary hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand-primary">
          View all
        </Link>
      </div>
              ...
              return (
                <li key={entry.id} className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-brand-accent/70">{relativeTime(entry.timestamp)}</p>
                  </div>
                </li>
              )
            })}
