...
const DEMO_FEED: ActivityEntry[] = [
  {
    id: '1',
    type: 'ticket_sold',
    description: 'Ticket sold for Summer Music Festival',
    timestamp: new Date(Date.now() - 2 * 60000).toISOString(),
  },
  {
    id: '2',
    type: 'event_published',
    description: 'Tech Conference 2026 published',
    timestamp: new Date(Date.now() - 15 * 60000).toISOString(),
  },
  {
    id: '3',
    type: 'verification_scan',
    description: 'Entry scan at Lagos Art Fair',
    timestamp: new Date(Date.now() - 45 * 60000).toISOString(),
  },
  {
    id: '4',
    type: 'ticket_sold',
    description: 'Ticket sold for Tech Conference 2026',
  ...
  },
  {
    id: '6',
    type: 'verification_scan',
    description: 'Entry scan at Summer Music Festival',
    timestamp: new Date(Date.now() - 5 * 3600000).toISOString(),
  },
  {
    id: '7',
    type: 'event_published',
    description: 'Lagos Art Fair published',
    timestamp: new Date(Date.now() - 8 * 3600000).toISOString(),
  },
  {
    id: '8',
    type: 'ticket_sold',
    description: 'Ticket sold for Lagos Art Fair',
  ...
  },
  {
    id: '10',
    type: 'verification_scan',
    description: 'Entry scan at Tech Conference 2026',
