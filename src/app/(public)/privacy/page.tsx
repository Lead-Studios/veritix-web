    ...
    <main className="min-h-screen bg-[#0b1025] text-white px-6 py-16">
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <section className="space-y-4 text-white/80 text-sm leading-relaxed">
          <p>
            VeriTix (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) is committed to
            protecting your personal information. This Privacy Policy explains how we
            collect, use, and safeguard data when you use our platform.
          </p>

          <h2 className="text-lg font-semibold text-white">Information We Collect</h2>
          <p>
            We collect information you provide directly (such as your email address and
            wallet address during registration), as well as usage data generated when you
          ...
          <p>
            ...
            transactions, send service-related communications, and comply with legal
            obligations.
          </p>
          ...
          <p>
            ...
            who assist us in operating the platform, subject to confidentiality
            obligations.
          </p>
