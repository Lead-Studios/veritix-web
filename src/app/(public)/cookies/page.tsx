    ...
    <main className="min-h-screen bg-[#0b1025] text-white px-6 py-16">
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <section className="space-y-4 text-white/80 text-sm leading-relaxed">
          <p>
            VeriTix uses cookies and similar technologies to provide, improve, and secure
            our services. This Cookie Policy explains what cookies we use and why.
          </p>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              <span className="font-medium text-white">Essential cookies</span> – required
              for the platform to function (e.g., session management).
            </li>
            <li>
