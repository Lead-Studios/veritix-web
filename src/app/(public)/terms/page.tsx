    ...
    <main className="min-h-screen bg-[#0b1025] text-white px-6 py-16">
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <section className="space-y-4 text-white/80 text-sm leading-relaxed">
          <p>
            By accessing or using VeriTix, you agree to be bound by these Terms of
            Service. Please read them carefully before using the platform.
          </p>

          <h2 className="text-lg font-semibold text-white">Use of the Platform</h2>
          <p>
            You may use VeriTix only for lawful purposes and in accordance with these
            Terms. You are responsible for maintaining the security of your wallet and
            account credentials.
          </p>
          ...
          <p>
            You may not use the platform to engage in fraud, scalping beyond permitted
            limits, or any activity that violates applicable law or the rights of others.
          </p>

          <h2 className="text-lg font-semibold text-white">Limitation of Liability</h2>
          <p>
            VeriTix is provided &quot;as is&quot;. To the maximum extent permitted by law,
            we disclaim all warranties and limit our liability for indirect or
