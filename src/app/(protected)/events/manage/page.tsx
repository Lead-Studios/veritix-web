...
import { prepareDuplicateDraft, type DuplicableEventData } from '@/lib/duplicateEvent';
    ...
    source: {
      ...
      tickets: [
        ...
        },
        {
          ...
          quantity: 50,
          price: '500',
          description: 'Includes private dinner',
          transferable: false,
          resellable: false,
          resellPriceLimit: '',
        },
